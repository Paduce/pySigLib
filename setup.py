...
class CustomBuild(_build_py):
    def run(self):
        ...
        with open(config_path, 'w') as f:
            ...
            f.write(f"DIR = {repr(DIR)}\n")
            f.write(f"VCTOOLSINSTALLDIR = {repr(VCTOOLSINSTALLDIR)}\n")
            f.write(f"CL_PATH = {repr(CL_PATH)}\n")
            f.write(f"CUDA_PATH = {repr(CUDA_PATH)}\n")
            f.write(f"INCLUDE = {repr(INCLUDE)}\n")
